...
APPLICATION='/ticketsampleapplication7855'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7855-desktop:1.0'
...
helm install --name ticketsampleapplication7855-7981 ./helm
if [ $? -eq 0 ]; then
